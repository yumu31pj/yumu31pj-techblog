    ...
    <SectionContainer id={"about"} paddingTop={80}>
      ...
      <div className={styles["c-home-about-section"]}>
        <div className={styles["c-home-about-section__image"]}>
          <picture>
            <source srcSet="/images/reproduce/1-profile/home/about1_sp.webp" type="image/webp" media="(max-width: 600px)" />
            <source srcSet="/images/reproduce/1-profile/home/about1_pc.webp" type="image/webp" media="(min-width: 601px)" />
            <source srcSet="/images/reproduce/1-profile/home/about1_pc.png" type="image/webp" media="(min-width: 601px)" />
